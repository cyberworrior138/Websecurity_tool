...
--------------------------------------------------
These tool coded by Mr.Virus hacker from Tanzania
Facing any problem visit instagram profile:
@uknown_virus404x 
--------------------------------------------------
""" + RESET)
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            t = start_loading("Scanning open ports")
            ...
            t = start_loading("Running full scan")
            ip = get_ip(domain)
            ports = scan_ports(domain)
            stop_loading()
            ...
            print(RED + "Exiting... Stay safe hacker " + RESET)
            sys.exit()
